...
result = model.predict(source='E:/fish/tropicalfishes.mp4', show=False, verbose=False, stream=True)
...
print ("start prediction : ", datetime.now())
result = model.predict(source='E:/fish/tropicalfishes.mp4', show=False, verbose=False, stream=False)
